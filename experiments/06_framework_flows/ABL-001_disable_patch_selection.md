...
配置：`experiments/02_ablation/ABL-001_disable_patch_selection/config.yaml`
...
| attempt | 状态 | 原因 | 日志副本 |
|---:|---|---|---|
| 1 | failed | Windows GBK 控制台无法编码日志中的 `⚠` 字符，训练未进入 epoch | `experiments/02_ablation/ABL-001_disable_patch_selection/logs/ABL-001_CUB_seed5_20260605-224002_attempt1_failed_encoding.txt` |
