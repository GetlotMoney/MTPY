...
| 命令 | `F:\Anaconda\envs\dvsr_gpu\python.exe train_VGSR_CUB.py --config experiments/05_ablation/ABL-005_disable_conditional_text/config.yaml` |
| 配置文件 | `experiments/05_ablation/ABL-005_disable_conditional_text/config.yaml` |
| 设备 | `cuda:0` |
| epoch | `30` |
...
|---:|---:|---:|---:|---:|---:|---|---|
| 5 | 72.97 | 71.29 | 72.12 | 81.86 | 10 | `train_log/CUB/training_log_CUB_2026-06-06_00-25-24.txt` | `experiments/05_ablation/ABL-005_disable_conditional_text/logs/ABL-005_CUB_seed5_20260606-002524.txt` |
...
- [x] 生成 `experiments/08_framework_flow_records/ABL-005_disable_conditional_text.md`，记录代码框架图、流程说明和本实验数据。
