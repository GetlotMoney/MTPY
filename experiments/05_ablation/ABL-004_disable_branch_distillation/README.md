...
| 命令 | `F:\Anaconda\envs\dvsr_gpu\python.exe train_VGSR_CUB.py --config experiments/05_ablation/ABL-004_disable_branch_distillation/config.yaml` |
| 配置文件 | `experiments/05_ablation/ABL-004_disable_branch_distillation/config.yaml` |
| 设备 | `cuda:0` |
| epoch | `30` |
...
|---:|---:|---:|---:|---:|---:|---|---|
| 5 | 73.30 | 68.83 | 71.00 | 81.52 | 9 | `train_log/CUB/training_log_CUB_2026-06-06_00-11-33.txt` | `experiments/05_ablation/ABL-004_disable_branch_distillation/logs/ABL-004_CUB_seed5_20260606-001133.txt` |
...
- [x] 生成 `experiments/08_framework_flow_records/ABL-004_disable_branch_distillation.md`，记录代码框架图、流程说明和本实验数据。
