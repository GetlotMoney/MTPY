...
| 命令 | `F:\Anaconda\envs\dvsr_gpu\python.exe train_VGSR_CUB.py --config experiments/05_ablation/ABL-002_disable_ag_jepa/config.yaml` |
| 配置文件 | `experiments/05_ablation/ABL-002_disable_ag_jepa/config.yaml` |
| 设备 | `cuda:0` |
| epoch | `30` |
...
|---:|---:|---:|---:|---:|---:|---|---|
| 5 | 76.00 | 66.76 | 71.08 | 81.66 | 11 | `train_log/CUB/training_log_CUB_2026-06-05_23-39-36.txt` | `experiments/05_ablation/ABL-002_disable_ag_jepa/logs/ABL-002_CUB_seed5_20260605-233936.txt` |
...
- [x] 生成 `experiments/08_framework_flow_records/ABL-002_disable_ag_jepa.md`，记录代码框架图、流程说明和本实验数据。
