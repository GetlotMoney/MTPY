...
- ID: MOD-001
- 名称: 几何感知属性路由
- 目录: `experiments/01_single_module_innovation/MOD-001_geometry_attribute_routing/`
...
- `experiments/01_single_module_innovation/MOD-001_geometry_attribute_routing/README.md`
- `experiments/01_single_module_innovation/MOD-001_geometry_attribute_routing/codex-self-review.md`
...
```text
experiments/01_single_module_innovation/MOD-001_geometry_attribute_routing/claude-review.md
```
