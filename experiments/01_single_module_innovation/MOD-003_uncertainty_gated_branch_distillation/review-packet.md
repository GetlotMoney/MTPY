...
- ID: MOD-003
- 名称: 带不确定性门控的分支一致性蒸馏
- 目录: `experiments/01_single_module_innovation/MOD-003_uncertainty_gated_branch_distillation/`
...
- `experiments/01_single_module_innovation/MOD-003_uncertainty_gated_branch_distillation/README.md`
- `experiments/01_single_module_innovation/MOD-003_uncertainty_gated_branch_distillation/codex-self-review.md`
...
```text
experiments/01_single_module_innovation/MOD-003_uncertainty_gated_branch_distillation/claude-review.md
```
