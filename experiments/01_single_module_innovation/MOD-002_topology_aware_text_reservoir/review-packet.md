...
- ID: MOD-002
- 名称: 拓扑感知的自适应文本属性库
- 目录: `experiments/01_single_module_innovation/MOD-002_topology_aware_text_reservoir/`
...
- `experiments/01_single_module_innovation/MOD-002_topology_aware_text_reservoir/README.md`
- `experiments/01_single_module_innovation/MOD-002_topology_aware_text_reservoir/codex-self-review.md`
...
```text
experiments/01_single_module_innovation/MOD-002_topology_aware_text_reservoir/claude-review.md
```
