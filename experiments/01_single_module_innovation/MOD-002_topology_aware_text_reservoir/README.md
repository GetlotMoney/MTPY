...
| 命令 | `F:\Anaconda\envs\dvsr_gpu\python.exe train_VGSR_CUB.py --config experiments/01_single_module_innovation/MOD-002_topology_aware_text_reservoir/config.yaml` |
| 配置文件 | `experiments/01_single_module_innovation/MOD-002_topology_aware_text_reservoir/config.yaml` |
...
|---:|---:|---:|---:|---:|---:|---|---|
| 5 | 75.39 | 64.02 | 69.24 | 80.78 | 22 | `train_log/CUB/training_log_CUB_2026-06-07_19-10-33.txt` | `experiments/01_single_module_innovation/MOD-002_topology_aware_text_reservoir/logs/MOD-002_CUB_seed5_20260607-191033.txt` |
...
- [x] 生成 `experiments/08_framework_flow_records/MOD-002_topology_aware_text_reservoir.md`。
- [x] 根据结果更新创意树权重。
