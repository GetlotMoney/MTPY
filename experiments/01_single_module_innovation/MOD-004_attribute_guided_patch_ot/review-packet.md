...
- ID: MOD-004
- 名称: 属性引导的局部补丁 OT 对齐
- 目录: `experiments/01_single_module_innovation/MOD-004_attribute_guided_patch_ot/`
...
- `experiments/01_single_module_innovation/MOD-004_attribute_guided_patch_ot/README.md`
- `experiments/01_single_module_innovation/MOD-004_attribute_guided_patch_ot/codex-self-review.md`
...
```text
experiments/01_single_module_innovation/MOD-004_attribute_guided_patch_ot/claude-review.md
```
