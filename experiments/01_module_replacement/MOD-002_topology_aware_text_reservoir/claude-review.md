...
```text
F:\Anaconda\envs\dvsr_gpu\python.exe train_VGSR_CUB.py --config experiments/01_module_replacement/MOD-002_topology_aware_text_reservoir/config.yaml
```
...
```text
experiments/01_module_replacement/MOD-002_topology_aware_text_reservoir/logs/
```
