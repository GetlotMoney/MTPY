...
| 数据集 | CUB |
| 随机种子 | 5 |
| 命令 | `F:\Anaconda\envs\dvsr_gpu\python.exe train_VGSR_CUB.py --config experiments/01_module_replacement/MOD-004_attribute_guided_patch_ot/config.yaml` |
...
- 实验日志副本: `experiments/01_module_replacement/MOD-004_attribute_guided_patch_ot/logs/MOD-004_CUB_seed5_20260607-195646.txt`
...
- [x] 生成 `experiments/06_framework_flows/MOD-004_attribute_guided_patch_ot.md`。
- [x] 根据结果更新创意树权重。
