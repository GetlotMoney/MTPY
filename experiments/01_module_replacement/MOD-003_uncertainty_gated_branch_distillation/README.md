...
| 数据集 | CUB |
| 随机种子 | 5 |
| 命令 | `F:\Anaconda\envs\dvsr_gpu\python.exe train_VGSR_CUB.py --config experiments/01_module_replacement/MOD-003_uncertainty_gated_branch_distillation/config.yaml` |
| 配置文件 | `experiments/01_module_replacement/MOD-003_uncertainty_gated_branch_distillation/config.yaml` |
...
|---:|---:|---:|---:|---:|---:|---|---|
| 5 | 72.83 | 72.39 | 72.61 | 81.15 | 51 | `train_log/CUB/training_log_CUB_2026-06-07_19-37-58.txt` | `experiments/01_module_replacement/MOD-003_uncertainty_gated_branch_distillation/logs/MOD-003_CUB_seed5_20260607-193758.txt` |
...
- [x] 生成 `experiments/06_framework_flows/MOD-003_uncertainty_gated_branch_distillation.md`。
- [x] 根据结果更新创意树权重。
