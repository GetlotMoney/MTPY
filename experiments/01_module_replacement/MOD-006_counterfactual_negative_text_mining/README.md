...
- `experiments/01_module_replacement/MOD-006_counterfactual_negative_text_mining/config.yaml`
...
| 数据集 | CUB |
| 随机种子 | 5 |
| 命令 | `F:\Anaconda\envs\dvsr_gpu\python.exe train_VGSR_CUB.py --config experiments/01_module_replacement/MOD-006_counterfactual_negative_text_mining/config.yaml` |
...
- [x] 生成 `experiments/06_framework_flows/MOD-006_counterfactual_negative_text_mining.md`。
- [x] 根据结果更新创意树权重。
