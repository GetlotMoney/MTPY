...
- `experiments/01_module_replacement/MOD-006_counterfactual_negative_text_mining/config.yaml`: 打开 `use_cf_neg_text=True`，设置 `lambda_cf_neg_text=0.03`。
...
F:\Anaconda\envs\dvsr_gpu\python.exe train_VGSR_CUB.py --config experiments/01_module_replacement/MOD-006_counterfactual_negative_text_mining/config.yaml
```
