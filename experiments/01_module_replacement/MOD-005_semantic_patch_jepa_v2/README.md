...
| 数据集 | CUB |
| 随机种子 | 5 |
| 命令 | `F:\Anaconda\envs\dvsr_gpu\python.exe train_VGSR_CUB.py --config experiments/01_module_replacement/MOD-005_semantic_patch_jepa_v2/config.yaml` |
...
- [x] 生成 `experiments/06_framework_flows/MOD-005_semantic_patch_jepa_v2.md`。
- [x] 根据结果更新创意树权重。
