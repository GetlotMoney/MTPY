...
| 命令 | `F:\Anaconda\envs\dvsr_gpu\python.exe train_VGSR_CUB.py --config experiments/01_module_replacement/MOD-001_geometry_attribute_routing/config.yaml` |
| 配置文件 | `experiments/01_module_replacement/MOD-001_geometry_attribute_routing/config.yaml` |
...
|---:|---:|---:|---:|---:|---:|---|---|
| 5 | 73.24 | 71.68 | 72.45 | 81.49 | 51 | `train_log/CUB/training_log_CUB_2026-06-07_18-23-26.txt` | `experiments/01_module_replacement/MOD-001_geometry_attribute_routing/logs/MOD-001_seed5_2026-06-07_18-23-26_training_log.txt` |
...
- [x] 生成 `experiments/06_framework_flows/MOD-001_geometry_attribute_routing.md`。
- [x] 根据结果更新创意树权重。
