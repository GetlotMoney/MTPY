...
只调正样本 JEPA 权重，不改负样本 margin。

## 运行命令

``powershell
python train_VGSR_CUB.py --config experiments/04_hyperparameter_tuning/TUNE-008_jepa_0/config.yaml
``
