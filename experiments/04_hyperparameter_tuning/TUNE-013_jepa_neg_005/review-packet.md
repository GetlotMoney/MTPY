...
- 只改 lambda_jepa_neg 从 0.02 到 0.05。
- 不改模型代码、训练脚本、数据加载、评估逻辑。

## 运行计划

``powershell
python train_VGSR_CUB.py --config experiments/04_hyperparameter_tuning/TUNE-013_jepa_neg_005/config.yaml
``
