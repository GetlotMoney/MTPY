...
- 只改 conditional_text_ratio 从 0.005 到 0.001。
- 不改模型代码、训练脚本、数据加载、评估逻辑。

## 运行计划

``powershell
python train_VGSR_CUB.py --config experiments/04_hyperparameter_tuning/TUNE-015_conditional_text_0001/config.yaml
``
