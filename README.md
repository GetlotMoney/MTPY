...
| 口径 | 配置 | U | S | H | ZSL |
|------|------|---:|---:|---:|---:|
| **当前最佳 / TUNE-024** | topo=0.1 + cond_text=0.01 + jepa_neg=0.01，严格连续 60 轮，seed=5 | 72.33 | 75.95 | **74.09** | 81.75 |
| 当前主基线 | 局部补丁选择 + 几何感知编码 + 双向视觉-文本交互 + 条件文本扰动 + AG-JEPA 辅助训练，多 seed 候选池取最高 H，严格连续 60 轮，seed=5 | 73.30 | 72.53 | 72.91 | 81.72 |
