...
| ID | 状态 | 模块 | 假设 | 来源/证据 | 迁移前要求 | 备注 |
|---|---|---|---|---|---|---|
| MOD-006 | done | 反事实负文本挖掘 | 近邻类别负描述可能提升细粒度边界 | GPT 类描述；反事实区分原则 | 已离线检查 `cub_gpt55.pt` / `cub_merge_readable.json` 和相似类列表 | seed=5 H=72.39，低于 baseline 72.91；当前训练期 margin 不保留 |
