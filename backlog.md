...
| `ABL-005` | open | 去掉条件文本扰动 | 图像条件化文本是否帮助 GZSL | `experiments/02_ablation/ABL-005_disable_conditional_text/config.yaml` | `F:\Anaconda\envs\dvsr_gpu\python.exe train_VGSR_CUB.py --config experiments/02_ablation/ABL-005_disable_conditional_text/config.yaml` | ABL-004 已完成；下一项消融实验 |
