...
| `ABL-005` | running | 去掉条件文本扰动 | 图像条件化文本是否帮助 GZSL | `experiments/02_ablation/ABL-005_disable_conditional_text/config.yaml` | `F:\Anaconda\envs\dvsr_gpu\python.exe train_VGSR_CUB.py --config experiments/02_ablation/ABL-005_disable_conditional_text/config.yaml` | 先审查，通过后再训练 |
